...
const OverviewSection: React.FC<OverviewSectionProps> = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-white/[0.04] via-white/[0.02] to-transparent border border-white/10 p-5 sm:p-6">
      ...
      <div className="absolute -top-2 -right-2 text-[120px] leading-none font-serif text-netflix-red/10 select-none pointer-events-none">
        “
      </div>

      <div className="relative z-10">
        <div className="flex items-center gap-2.5 mb-4">
          <div className="w-8 h-8 rounded-lg bg-netflix-red/15 flex items-center justify-center">
        ...
        {tagline && (
          <p className="text-sm sm:text-base text-gray-300 italic mb-4 border-l-2 border-netflix-red/50 pl-3">
            “{tagline}”
          </p>
        )}
