...
/**
 * Former p-stream default (near-black grays + purple accent).
 * Kept as a selectable skin after CINEFLIX brand became the true default.
 */
const tokens = {
  black: {
    c50: "#000000",
